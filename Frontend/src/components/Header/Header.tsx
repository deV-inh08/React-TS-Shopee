...
const Header = () => {
    ...
    const totalQuantity = cartItems.reduce((sum, cart) => (sum + cart.quantity),0);
                    ...
                    <div className='col-span-1 justify-self-start'>
                        <Popover renderPopover={
                           ...
                           <Link to="/cart" className='relative'>
                                    ...
                                    <span className='absolute -top-4 -right-1 bg-white text-orange text-sm px-2 rounded'>{totalQuantity}</span>
                            </Link>
                        </Popover>
                    </div>
                </div>
